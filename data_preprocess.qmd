...
# Plot using ggplot
ggplot() +
  geom_area(data = total_car, aes(x = as.numeric(Year), y = Cars, fill = Country, group = Country), alpha = 0.5, size = 0.8) +
  ...
  annotate(geom = "text", x = as.numeric("2004"), y = 1e+6, hjust = 0, vjust = 1.5, size = 3, label = "Production rate diverges", color = "black", angle = 90) +
  annotate(geom = "text", x = as.numeric("2009"), y = 1e+6, hjust = 0, vjust = 1.5, size = 3, label = "Asian Financial Crisis", color = "black", angle = 90) +
  annotate(geom = "text", x = as.numeric("2020"), y = 1e+6, hjust = 0, vjust = 1.5, size = 3, label = "Covid-19 Epidemic", color = "black", angle = 90) +
...
ggplot() +
  ...
  geom_line(data = oil_sum, aes(x = Year, y = total, color = 'Oil Change'), group = 1, linetype = 'solid', size = 0.6, alpha = 1) +
  ...
  annotate(geom = "text", x = "2004", y = -24, hjust = 0, vjust = 3, size = 3, label = "Production rate diverges", color = "black", angle = 90) +
  annotate(geom = "text", x = "2009", y = -24, hjust = 0, vjust = 3, size = 3, label = "Asian Financial Crisis", color = "black", angle = 90) +
  annotate(geom = "text", x = "2020", y = -24, hjust = 0, vjust = 3, size = 3, label = "Covid-19 Epidemic", color = "black", angle = 90) +
