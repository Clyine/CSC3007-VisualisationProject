...
ggplot() +
  geom_area(data = data, aes(x=Year, y=Car_Change, group = Country, fill=Country), linetype = 'solid', size=0.8, alpha=0.5) +
  ...
  annotate(geom = "text", x = "2004", y = -35, hjust=0.1, vjust = 3, size = 3, label = "Production rate diverges", color = "black", angle = 90) +
  annotate(geom = "text", x = "2009", y = -35, hjust=0.1, vjust = 3, size = 3, label = "Asian Financial Crisis", color = "black", angle = 90) +
  annotate(geom = "text", x = "2020", y = -35, hjust=0.1, vjust = 3, size = 3, label = "Covid-19 Epidemic", color = "black", angle = 90) +
