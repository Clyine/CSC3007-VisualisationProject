...
total_car = all_data_grouped %>%
  ...
  ggplot() +
  geom_area(data=total_car, aes(x=Year, y=Cars, fill=Country, group=Country), alpha = 0.5, size=0.8) +
  geom_line(data=total_oil, aes(x=Year, y=Sum*1300, group=1, color='Oil'), size=1) +
  ...
  annotate(geom = "text", x = "2004", y = 1e+6, hjust=0, vjust = 1.5, size = 3,label = "Production rate diverges", color = "black",
             angle = 90) +
  annotate(geom = "text", x = "2009", y = 1e+6, hjust=0, vjust = 1.5,size = 3,label = "Asian Financial Crisis", color = "black",
         angle = 90) +
  annotate(geom = "text", x = "2020", y = 1e+6, hjust=0, vjust = 1.5,size = 3,label = "Covid-19 Epidemic", color = "black",
         angle = 90) +
  xlim(1999,2023) +
  labs(title = "Total Car and Oil Production",
       subtitle = "By BRIC & non-BRIC Countries and Year",
       x = "Year",
       y = "Total Car Production",
       caption = "Source: EIA, OCIA") +
  scale_y_continuous(labels = unit_format(unit = "M", scale = 1e-6),
                     sec.axis = sec_axis(~ . / 1300, name = "Total Oil Production Oil (Mb/d)", labels= unit_format(unit = "K", scale=1e-3)),
                     expand= c(0,1)) +
...
```
## Year on year change in production for Car and Oil
```{r}
...
ggplot() +
  geom_area(data = data, aes(x=Year, y=Car_Change, group = Country, fill=Country), linetype = 'solid', size=0.8, position='identity', alpha=0.5) +
  geom_line(data = oil_sum, aes(x=Year, y=total, color='Oil Change'), group=1, linetype = 'solid', size=0.8, alpha=1) +
  geom_vline(xintercept = "2004", linetype = 2, color = 'black', linewidth = 0.5) +
  geom_vline(xintercept = "2009", linetype = 2, color = 'black', linewidth = 0.5) +
  geom_vline(xintercept = "2020", linetype = 2, color = 'black', linewidth = 0.5) +
  annotate(geom = "text", x = "2004", y = -24, hjust=0, vjust = 1.5, size = 3,label = "Production rate diverges", color = "black",
             angle = 90) +
  annotate(geom = "text", x = "2009", y = -24, hjust=0, vjust = 1.5,size = 3,label = "Asian Financial Crisis", color = "black",
         angle = 90) +
  annotate(geom = "text", x = "2020", y = -24, hjust=0, vjust = 1.5,size = 3,label = "Covid-19 Epidemic", color = "black",
         angle = 90) +
  geom_hline(yintercept = 0) +
  geom_vline(xintercept = "1999") +
  scale_x_discrete(breaks = function(x){x[c(TRUE, FALSE)]},
                 expand= c(0,0)) +
  scale_color_manual(labels=c("Oil Production"),
                     values=c("#000000")) +
  scale_fill_discrete(labels=c("BRIC - Car Production", "Non-BRIC - Car Production")) +
  labs(title = "Year on Year change on Car and Oil Production",
       subtitle = "By BRIC & non-BRIC Countries and Year",
       x = "Year",
       y = "% Change",
       caption = "Source: EIA, OCIA") +
