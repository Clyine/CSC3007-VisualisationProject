...
1. *Do not add flags to the graph* as they do not add value.

1. *The growth paths divergence* can be better emphasized.
...
*   Car production data by country/region were obtained from the International
    ...
    2017[^production_stats_by_region_2017]. 
...
[^production_stats_by_region_2017]: <https://www.oica.net/category/production-statistics/>
