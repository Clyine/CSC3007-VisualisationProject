...
2.  There is a sharp increase in car production in BRIC countries in the years following 2005.

3.  The main comparison made was between BRIC and non-BRIC countries.
...
2.  *Do not add flags to the graph* it adds significant amount of visual clutter due to the sheer number of countries

3.  *The growth paths divergence* can be better emphasized, more contrasting colors can be chosen. Current graph uses black on black.
